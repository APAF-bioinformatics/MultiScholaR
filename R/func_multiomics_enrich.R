...
# ============================================================================
# Purpose: Multiomics enrichment analysis functions
# 
# This file contains functions for multiomics enrichment analysis, including
# StringDB enrichment, metabolomics pathway enrichment, and rank-based
# enrichment methods. Functions in this file are used by multiomics enrichment
# modules and related workflows.
#
# Functions to extract here:
# - submitStringDBEnrichment(): Submit enrichment job to StringDB
# - downloadStringDBGraph(): Download StringDB network graph
# - downloadStringDBResultsFile(): Download StringDB results file
# - retrieveStringDBEnrichmentResults(): Retrieve StringDB enrichment results
# - runOneStringDbRankEnrichment(): Run rank-based StringDB enrichment
# - runOneStringDbRankEnrichmentMofa(): Run MOFA-based StringDB enrichment
# - runStringDbEnrichmentAllContrasts(): Run StringDB enrichment for all contrasts
# - runStringDbEnrichmentFromDAResults(): Run StringDB enrichment from DE results
# - runStringDbEnrichmentFromDAResultsMultiple(): Run StringDB enrichment for multiple results
# - runMetabolomicsEnrichmentAnalysis(): Run metabolomics enrichment analysis
# - runMetabolomicsPathwayEnrichment(): Run metabolomics pathway enrichment
# - printStringDbFunctionalEnrichmentBarGraph(): Print StringDB enrichment bar graph
# - getStringDbSpecies(): Get StringDB species information
# - searchStringDbSpecies(): Search for StringDB species
# - Additional multiomics enrichment helper functions
#
# Dependencies:
...
# Function 1: submitStringDBEnrichment()
# Current location: R/multiomics_enrichment_functions.R
# Description: Submits enrichment job to StringDB API
# submitStringDBEnrichment <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 2: downloadStringDBGraph()
# Current location: R/multiomics_enrichment_functions.R
# Description: Downloads StringDB network graph
# downloadStringDBGraph <- function(graph_url) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 3: downloadStringDBResultsFile()
# Current location: R/multiomics_enrichment_functions.R
# Description: Downloads StringDB results file
# downloadStringDBResultsFile <- function(download_url) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 4: retrieveStringDBEnrichmentResults()
# Current location: R/multiomics_enrichment_functions.R
# Description: Retrieves StringDB enrichment results
# retrieveStringDBEnrichmentResults <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 5: runOneStringDbRankEnrichment()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs rank-based StringDB enrichment for one input
# runOneStringDbRankEnrichment <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 6: runOneStringDbRankEnrichmentMofa()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs MOFA-based StringDB enrichment
# runOneStringDbRankEnrichmentMofa <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 7: runStringDbEnrichmentAllContrasts()
# Current location: R/string_enrichment_functions_refactored.R
# Description: Runs StringDB enrichment for all contrasts
# runStringDbEnrichmentAllContrasts <- function(...) {
#   # Extract from R/string_enrichment_functions_refactored.R
# }

# Function 8: runStringDbEnrichmentFromDAResults()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs StringDB enrichment from DE results
# runStringDbEnrichmentFromDAResults <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 9: runStringDbEnrichmentFromDAResultsMultiple()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs StringDB enrichment for multiple DE results
# runStringDbEnrichmentFromDAResultsMultiple <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 10: runMetabolomicsEnrichmentAnalysis()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs metabolomics enrichment analysis
# runMetabolomicsEnrichmentAnalysis <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 11: runMetabolomicsPathwayEnrichment()
# Current location: R/multiomics_enrichment_functions.R
# Description: Runs metabolomics pathway enrichment
# runMetabolomicsPathwayEnrichment <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 12: printStringDbFunctionalEnrichmentBarGraph()
# Current location: R/multiomics_enrichment_functions.R
...
# Function 13: getStringDbSpecies()
# Current location: R/multiomics_enrichment_functions.R
# Description: Gets StringDB species information
# getStringDbSpecies <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 14: searchStringDbSpecies()
# Current location: R/multiomics_enrichment_functions.R
# Description: Searches for StringDB species
# searchStringDbSpecies <- function(...) {
#   # Extract from R/multiomics_enrichment_functions.R
# }

# Function 15: plotStringDbEnrichmentResults()
# Current location: R/string_enrichment_functions_refactored.R
...
runMetabolomicsPathwayEnrichment <- function(weights, 
  ...
  if (nrow(combined_results) == 0) {
    ...
    # Check if mappedIDs column exists
    if (!"mappedIDs" %in% colnames(combined_results)) {
      ...
      map_ids_to_names <- function(id_string, assay_type) {
        # Robust check for NA, NULL, or empty
        if (is.null(id_string) || length(id_string) == 0 || isTRUE(is.na(id_string[1])) || id_string[1] == "") {
