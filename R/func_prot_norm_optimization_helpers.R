...
#' and applies `findBestKElbow()` to each plot to determine the optimal
...
#'   for assays where `findBestKElbow` fails or returns an invalid result.
#'
...
findBestKForAssayList <- function(cancor_plots_list) {
    ...
    # --- Iterate and Apply findBestKElbow ---
...
#' separation quality and the resulting k value from findBestKElbow(). This prevents
...
#' @param best_k The best k value from findBestKElbow()
