    ...
    shiny::moduleServer(id, function(input, output, session) {
        ...
        shiny::observeEvent(input$save_workflow_args, {
            ...
            tryCatch({
                ...
                if (!is.null(workflow_data$state_manager)) {
                    ...
                    data_states <- c("lipid_correlation_filtered", "lipid_norm_complete",
                                   "lipid_ruv_corrected", "lipid_normalized",
                                   "loaded_for_de", "lipid_qc_complete")
        ...
        shiny::observeEvent(input$generate_report, {
            ...
            shiny::withProgress(message = "Generating report...", {
                ...
                # Determine template filename for lipidomics
                template_filename <- "lipidomics_report.rmd"
                ...
                if (!file.exists(report_template_path)) {
                    ...
                    tryCatch({
                        ...
                        pkg_file <- system.file("reports", "lipidomics", template_filename, package = "MultiScholaR")
