...
# ============================================================================
# mod_metab_norm_itsd.R
# ============================================================================
# Purpose: Metabolomics ITSD selection and normalization sub-module
# ============================================================================

#' @title Metabolomics ITSD Module
#' @description A Shiny module for selecting internal standards and applying ITSD normalization.
#' @name mod_metab_norm_itsd
NULL

#' @rdname mod_metab_norm_itsd
#' @export
#' @importFrom shiny NS tagList tabPanel br fluidRow column wellPanel h5 hr uiOutput icon helpText
mod_metab_norm_itsd_ui <- function(id) {
    ns <- shiny::NS(id)
...
mod_metab_norm_itsd_server <- function(id, workflow_data, omic_type, experiment_label) {
    shiny::moduleServer(id, function(input, output, session) {
        ...
        shiny::observe({
            ...
            if (!is.null(current_s4) && inherits(current_s4, "MetaboliteAssayData")) {
                itsd_data$assay_names <- names(current_s4@metabolite_data)
...
# <!-- APAF Bioinformatics | mod_metab_norm_itsd.R | Approved | 2026-03-17 -->
