...
#' @export
#' @param input_title Runtime inputs used by this function; see the usage section for accepted values.
...
#' @param include_protein_label Runtime inputs used by this function; see the usage section for accepted values.
...
getGlimmaVolcanoProteomicsWidget <- function(
  ...
  if (coef <= ncol(r_obj$coefficients)) {
    ...
    # Prepare status
    status_result <- limma::decideTests(r_obj, adjust.method = "none")
...
#' @param selected_data A table generated by [getSignificantData()].
#' @param log_q_value_column The name of the column representing the log q-value.
#' @param log_fc_column The name of the column representing the log fold-change.
#' @param q_val_thresh A numerical value specifying the q-value threshold for statistically significant proteins.
