...
PeptideQuantitativeData <- setClass("PeptideQuantitativeData",
  ...
  validity = function(object) {
    ...
    samples_in_peptide_data <- object@peptide_data |>
      distinct(!!sym(object@sample_id)) |>
      dplyr::pull(!!sym(object@sample_id))
...
setMethod(
  f = "cleanDesignMatrixPeptide",
  signature = "PeptideQuantitativeData",
  definition = function(theObject) {
    samples_id_vector <- theObject@peptide_data |>
...
#' @export
setMethod(
  f = "srlQvalueProteotypicPeptideClean",
  signature = "PeptideQuantitativeData",
  definition = function(
    theObject,
    ...
    choose_only_proteotypic_peptide <- checkParamsObjectFunctionSimplify(
      theObject,
      "choose_only_proteotypic_peptide",
      1
    )

    input_matrix_column_ids <- checkParamsObjectFunctionSimplify(
      theObject,
    ...
    search_srl_quant_cln <- srlQvalueProteotypicPeptideCleanHelper(
      input_table = peptide_data,
      input_matrix_column_ids = unique(c(
        input_matrix_column_ids,
        protein_id_column,
...
setMethod(
  ...
  definition = function(theObject, core_utilisation = NULL) {
    ...
    theObject@peptide_data <- rollUpPrecursorToPeptideHelper(
      input_table = peptide_data,
...
setMethod(
  ...
  definition = function(theObject, peptides_intensity_cutoff_percentile = NULL, peptides_proportion_of_samples_below_cutoff = NULL, core_utilisation = NULL) {
    ...
    peptides_intensity_cutoff_percentile <- checkParamsObjectFunctionSimplify(
      theObject,
    ...
    peptides_proportion_of_samples_below_cutoff <- checkParamsObjectFunctionSimplify(
      theObject,
    ...
    print(sprintf(
      "      peptideIntensityFiltering: Calculated min_peptide_intensity_threshold = %g (percentile %g%%)",
    ...
    print(sprintf(
      "   peptideIntensityFiltering: Helper function returned. New dims = %d rows, %d cols",
...
#' @export
setMethod(
  f = "removePeptidesWithMissingValuesPercent",
  signature = "PeptideQuantitativeData",
  definition = function(
    theObject,
    grouping_variable = NULL,
    ...
    grouping_variable <- checkParamsObjectFunctionSimplify(
      theObject,
      "grouping_variable",
      NULL
    )
    ...
    min_protein_intensity_threshold <- ceiling(quantile(
      ...
      na.rm = TRUE,
      probs = c(peptides_intensity_cutoff_percentile / 100)
    ))[1]
...
setMethod(
  ...
  definition = function(theObject, ...) {
    ...
    theObject@peptide_data <- filterMinNumPeptidesPerProteinHelper(
      input_table = peptide_data,
...
#' @export
setMethod(
  f = "filterMinNumPeptidesPerSample",
  signature = "PeptideQuantitativeData",
  definition = function(
    theObject,
    ...
    peptides_per_sample_cutoff <- checkParamsObjectFunctionSimplify(
      theObject,
      "peptides_per_sample_cutoff",
      5000
    )

    inclusion_list <- checkParamsObjectFunctionSimplifyAcceptNull(
      theObject,
      "inclusion_list",
      NULL
    )
...
#' @export
setMethod(
  f = "removePeptidesWithOnlyOneReplicate",
  signature = "PeptideQuantitativeData",
  definition = function(theObject, replicate_group_column = NULL, core_utilisation = NULL) {
    ...
    theObject@peptide_data <- removePeptidesWithOnlyOneReplicateHelper(
      input_table = peptide_data,
...
#' @export
setMethod(
  f = "plotPeptidesProteinsCountsPerSample",
  signature = "PeptideQuantitativeData",
  definition = function(theObject) {
...
#' @export
setMethod(
  f = "peptideMissingValueImputation",
  signature = "PeptideQuantitativeData",
  definition = function(theObject, imputed_value_column = NULL, proportion_missing_values = NULL, core_utilisation = NULL) {
    ...
    proportion_missing_values <- checkParamsObjectFunctionSimplifyAcceptNull(
      theObject,
    ...
    peptide_values_imputed <- peptideMissingValueImputationHelper(
      input_table = peptide_data,
...
compareTwoPeptideDataObjects <- function(object_a, object_b) {
  ...
  comparisons_list <- list(
    peptides = list(
      in_a_not_b = peptides_in_a_not_b,
...
summarisePeptideObject <- function(theObject) {
  ...
  summary_list <- list(
    num_peptides = nrow(num_peptides),
...
setMethod(
  ...
  definition = function(theObject) {
    ...
    peptide_quant_table <- peptide_data |>
      ...
      dplyr::rename(
        Protein.Ids = !!sym(theObject@protein_id_column),
...
#' @export
setGeneric(
  name = "getNegCtrlProtAnovaPeptides",
  def = function(
    theObject,
...
#' @export
setGeneric(
  name = "findBestNegCtrlPercentagePeptides",
  def = function(theObject,
...
#' @export
setMethod(
  f = "findBestNegCtrlPercentagePeptides",
  signature = "PeptideQuantitativeData",
  definition = function(theObject,
                        percentage_range = seq(1, 20, by = 1),
                        num_components_to_impute = 5,
...
#' @export
setMethod(
  f = "peptideMissingValueImputationLimpa",
  signature = "PeptideQuantitativeData",
  definition = function(theObject,
                        imputed_value_column = NULL,
                        use_log2_transform = TRUE,
...
setMethod(
  ...
  definition = function(theObject, tech_rep_remove_regex, correlation_group = NA) {
    ...
    correlation_vec <- calculatePeptidePearsonCorrelation(
      temp_obj,
...
#' @export
setGeneric(
  name = "log2TransformPeptideMatrix",
  def = function(theObject) {
...
setMethod(
  ...
  definition = function(
    ...
    # --- Map Old to New IDs ---
    accession_mapping <- chooseBestProteinAccessionHelper(
      input_tbl = peptide_data,
