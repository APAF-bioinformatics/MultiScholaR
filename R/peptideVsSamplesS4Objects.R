...
#'@export
setGeneric(name="cleanDesignMatrixPeptideMatrix"
           , def=function( theObject) {
             standardGeneric("cleanDesignMatrixPeptideMatrix")
           }
           , signature = c("theObject") )

#'@exportMethod cleanDesignMatrixPeptideMatrix
setMethod( f ="cleanDesignMatrixPeptideMatrix"
           , signature = "PeptideQuantitativeData"
           , definition=function( theObject ) {
             
             samples_id_vector <- colnames( theObject@peptide_matrix) 
