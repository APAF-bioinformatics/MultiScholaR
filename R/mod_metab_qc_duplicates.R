...
# ============================================================================
# Purpose: Metabolite duplicate resolution Shiny module
#
# This module wraps the resolveDuplicateFeaturesByIntensity() function to
# provide an interactive UI for identifying and resolving duplicate metabolites.
# ============================================================================

#' @title Metabolite Duplicate Resolution Module
#' @description A Shiny module for identifying and resolving duplicate metabolite features.
    ...
    shiny::moduleServer(id, function(input, output, session) {
        ...
        output$duplicate_tables <- shiny::renderUI({
            ...
            if (length(assays_with_dups) == 0) {
                return(shiny::wellPanel(
                    ...
                    , shiny::p("All metabolite IDs are unique. No resolution needed.")
                ))
            }
        ...
        shiny::observeEvent(input$resolve_duplicates, {
            ...
            tryCatch({
                ...
                current_s4@metabolite_data <- resolved_assay_list
                ...
                result_text <- paste(
                    ...
                    , ""
                    , "State saved as: 'metab_duplicates_resolved'"
                    , sep = "\n"
                )
                ...
                shiny::removeNotification("metab_dup_resolve_working")
                shiny::showNotification(
