...
# ============================================================================
# mod_metab_norm_scale.R
# ============================================================================
# Purpose: Metabolomics scaling and normalization sub-module (Proteomics UX)
# ============================================================================

#' @title Metabolomics Scaling/Normalization Module
#' @description A Shiny module for between-sample normalization and visualization.
#' @name mod_metab_norm_scale
NULL

#' @rdname mod_metab_norm_scale
#' @export
#' @importFrom shiny NS tagList tabPanel br fluidRow column h5 textOutput imageOutput hr tags
#' @importFrom shinyjqui jqui_resizable
mod_metab_norm_scale_ui <- function(id, plot_type = c("pca", "density", "rle", "correlation")) {
    ns <- shiny::NS(id)
...
#' @rdname mod_metab_norm_scale
#' @export
mod_metab_norm_scale_server <- function(id, workflow_data, experiment_paths, norm_data, plot_type) {
...
# <!-- APAF Bioinformatics | mod_metab_norm_scale.R | Approved | 2026-03-17 -->
