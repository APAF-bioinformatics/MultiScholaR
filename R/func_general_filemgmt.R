...
setupDirectories <- function(base_dir = here::here(), omic_types, label = NULL, force = FALSE, reuse_existing = FALSE) {
    ...
    for (current_omic_type in parsed_omic_types) {
        ...
        # --- Create Directories and Copy Scripts (if not reusing OR if reusing but dirs missing) ---
        # Modified logic: Even if reuse_current_omic_dirs is TRUE, we should ensure the directories exist.
        # The 'reuse' flag mainly prevents overwriting/wiping.
...
# ============================================================================
# Lipidomics S4 Parameter Extraction Helper
# ============================================================================
