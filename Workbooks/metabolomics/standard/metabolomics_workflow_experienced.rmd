...
if (exists("metabolite_data_cln") && is.list(metabolite_data_cln) && length(metabolite_data_cln) > 0) {
    ...
    # Maintain the original names of the list elements
    list_names <-  names( metabolite_data_cln)
    ...
    # Preserve the original names of the list
    if (!is.null(list_names)) {
        names(metabolite_data_cln) <- list_names
    }
