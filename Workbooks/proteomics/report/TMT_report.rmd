...
and reliable downstream statistical analysis. First, protein accessions were 
cleaned and validated against the provided FASTA reference database to ensure 
accurate annotation and to select the best representative protein ID when 
multiple accessions were present. Duplicate protein entries were removed to 
prevent redundancy in quantification.
