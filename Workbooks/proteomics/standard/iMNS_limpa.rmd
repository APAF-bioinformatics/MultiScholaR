...
```{r}
# Grouping by Sample ID minus the rep suffix
ruv_normalised_filtered_results_obj@technical_replicate_id <- "factor2"  

# Keep relevant metadata columns
ruv_normalised_for_de_analysis_obj <- averageTechReps(
    ruv_normalised_filtered_results_obj,
    design_matrix_columns = c("group", "factor2")  
)


# ruv_normalised_filtered_results_obj@protein_quant_table
# ruv_normalised_filtered_results_obj@design_matrix
