...
FormatMethodDetailsLFQ <- function(numbers) {
  ...
  ruv_text <- if (isTRUE(ruv_applied_val)) {
    ...
    "RUV-III batch correction was not applied due to dataset constraints. The analysis proceeded directly with normalized data for differential expression analysis."
  }
