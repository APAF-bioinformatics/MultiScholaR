...
This example shows how to use the new `runStringDbEnrichmentFromDAResults` function with a `de_results_for_enrichment` S4 object, which provides more flexibility in ranking methods.
...
enrichment_combined_score <- runStringDbEnrichmentFromDAResults(
...
enrichment_fdr_ranking <- runStringDbEnrichmentFromDAResults(
...
enrichment_fc_ranking <- runStringDbEnrichmentFromDAResults(
  de_results_for_enrichment = de_results_for_enrichment_object,
...
all_contrast_enrichment <- runStringDbEnrichmentFromDAResultsMultiple(
  de_results_for_enrichment = de_results_for_enrichment_object,
...
cat("Available ranking methods for runStringDbEnrichmentFromDAResults:\n")
