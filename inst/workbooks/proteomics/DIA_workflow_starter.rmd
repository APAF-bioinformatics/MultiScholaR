...
installMultiScholaR <- function(verbose = TRUE) {
    ...
    # Install MultiScholaR from GitHub
...
best_k <- optimization_result$best_k  # No need to call findBestKElbow() again!
...
####----(Optional) this section is not required if you have already defined the contrasts earlier in the same R session----#####
