...
vroom::vroom_write( ruv_normalised_for_de_analysis_obj@protein_quant_table, 
             file.path(project_dirs[[paste0(omic_type, "_", experiment_label)]]$protein_qc_dir, "proteomics_ruv_normalised_for_de_analysis_obj.tsv"))
```
...
ruv_normalised_for_de_analysis_obj@design_matrix <- ruv_normalised_for_de_analysis_obj@design_matrix |>
  mutate(
    temp_group = group,
    group = factor1,
    factor1 = temp_group
...
top_de_genes <- imap_dfr(de_analysis_results_list, ~{
  cat("Processing top genes for contrast:", .y, "\n")
  
  # Filter for significant genes
  significant_genes <- .x$de_proteins_long |>
